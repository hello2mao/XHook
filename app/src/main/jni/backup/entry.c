...
#include "base/util.h"
#include "com_mhb_xhook_NativeEntry.h"
...
JNIEXPORT void JNICALL Java_com_mhb_xhook_NativeEntry_initSystemNativeHook( JNIEnv* env, jclass this )
{
...
JNIEXPORT void JNICALL Java_com_mhb_xhook_NativeEntry_initCustomNativeHook(JNIEnv* env, jclass this, jstring lib_name){
